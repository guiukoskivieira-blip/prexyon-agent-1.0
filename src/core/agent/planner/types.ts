        ...
        properties: {
          ...
          arguments: {
            ...
            properties: {
              ...
              format: { type: 'STRING' },
              colorHex: { type: 'STRING', description: 'Cor em formato hexadecimal ou nome (ex: #ff313d, #000000, vermelho)' },
              fromColorHex: { type: 'STRING', description: 'Cor de origem a ser substituída em hexadecimal ou nome' },
              toColorHex: { type: 'STRING', description: 'Nova cor de preenchimento em hexadecimal ou nome (ex: #0000ff, azul)' },
              nodeIds: { type: 'ARRAY', items: { type: 'STRING' }, description: 'Lista de IDs dos nós para modificar/agrupar/excluir' },
              groupId: { type: 'STRING', description: 'ID do grupo para desagrupar' },
              groupName: { type: 'STRING', description: 'Nome legível do grupo' },
              targetGroupId: { type: 'STRING', description: 'ID opcional do grupo para restringir busca' },
              exactMatch: { type: 'BOOLEAN', description: 'Correspondência exata de cor' },
            },
          },
